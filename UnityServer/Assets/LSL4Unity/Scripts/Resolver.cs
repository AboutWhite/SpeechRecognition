...
namespace Assets.LSL4Unity.Scripts
{
    ...
    public class Resolver : MonoBehaviour, IEventSystemHandler
    {
        ...
        public float forgetStreamAfter = 100000000.0f;
        ...
        public bool IsStreamAvailable(out LSLStreamInfoWrapper info, string streamName = "SpeechRecognition", string streamType = "Numbers", string hostName = "")
        {
            Debug.Log("test");
